...
writer_loc ='/home/chaimeleon/persistent-home/classification_model_originalimage/totalsegment_work/resampled/embedding_LR/logs'
save_model_loc = '/home/chaimeleon/persistent-home/classification_model_originalimage/totalsegment_work/resampled/embedding_LR/models'
csv_location = '/home/chaimeleon/persistent-home/Complete_set/Experiments/Results/'

# model saving directory
train_dir = r"/home/chaimeleon/persistent-home/classification_model_originalimage/totalsegment_work/resampled/centrecrop_correct2/normalized/split_train_val/train"
val_dir = r"/home/chaimeleon/persistent-home/classification_model_originalimage/totalsegment_work/resampled/centrecrop_correct2/normalized/train_val"
    
train_label = r'/home/chaimeleon/persistent-home/classification_model_originalimage/totalsegment_work/resampled/centrecrop_correct2/normalized/split_train_val/train_labels.csv'
val_label = r'/home/chaimeleon/persistent-home/classification_model_originalimage/totalsegment_work/resampled/embedding_LR/forcombine_model/trainval_labels_forsagittal.csv'

base_dir = '/home/chaimeleon/persistent-home/classification_model_originalimage/totalsegment_work/resampled/embedding_LR/forcombine_model'

Batch_size = 1
num_epochs = 200
num_worker =8

Prefix = 'EM_LR192' #Increased Pos weight
# prior_name ='gland'
...
def validation(model1,model2,fmEncoder,val_loader,device,loss_function1,loss_function2, csv_prefix=''):
    ...
    evi_labels_path = os.path.join(base_dir, f"{csv_prefix}_evi.npy")
    mfi_labels_path = os.path.join(base_dir, f"{csv_prefix}_mfi.npy")
...
def RunInference():
        ...
        # val_dir = val_dir.replace('/train_val','/test')
        ...
        val_loss1,val_loss2, metrics_evi, metrics_mfi = validation(model1,model2,fmEncoder,val_loader,device,loss_function1,loss_function2,csv_prefix='trainval')
