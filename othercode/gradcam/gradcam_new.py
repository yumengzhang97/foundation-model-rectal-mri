...
# test_dir = r"/home/chaimeleon/persistent-home/classificationmodel_harmonizednew/axial_harmonize/rectum_centrecrop2/test"
# test_labels_dir = r'/home/chaimeleon/persistent-home/classificationmodel_harmonizednew/axial_harmonize/rectum_centrecrop2/test_labels.csv'
...
# target_filename = '48d0879e1b7b2264fdabfd93c79841812daecd3b56bf3b2cec8374ab2557f830'  # ??? .nii.gz
...
# target_filename = '501a48b625f67dd6792560a5f51164b2d0e566d042d4489003698e85d5e369a6'
# target_filename = 'b6f3d66fb76b92fadbdab1b579debe43dc8add938602ee76fdf2f34740e5b2a9'
# target_filename = '691892b25f1d33f693fffa0011d5e1ec826d01776dd6334220e9e0519afdc808'
# target_filename = '77ee1f9d55fa40a9e6793305b392048ac6e1f39d453381b354a7da43efc8ec90'
target_filename = '1d114f976a2a4a95957f2b8819ca0dbab644eb8fe3813161b791fe2f287c31a7'
...
print(f"Grayscale CAM shape: {grayscale_cam2.shape}")
 #1，192，192,36
...
for slice_index in slice_range:
    ...
    #Prepare CAM2
    grayscale_cam_slice2 = grayscale_cam2[0, :, :, slice_index] #192,192
    grayscale_cam_slice2 = (grayscale_cam_slice2 - np.min(grayscale_cam_slice2))/(np.max(grayscale_cam_slice2) - np.min(grayscale_cam_slice2))
    grayscale_cam_uint8_2 = np.uint8(255 * grayscale_cam_slice2) #192,192
    ...
    plt.subplot(1, 3, 2)
    plt.imshow(np.rot90(overlay2))
    plt.title("Grad-CAM MFI")
    plt.axis('off')
